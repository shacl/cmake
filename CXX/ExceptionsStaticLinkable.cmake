...
set(CXX_exceptions_static_linkable_root_dir 
  ${CMAKE_CURRENT_LIST_DIR}/ExceptionsStaticLinkable
  CACHE INTERNAL ""
)

function(CXX_exceptions_static_linkable)
  foreach(lang IN LISTS ARGN)
    ...
    message("test_project_source_dir = ${test_project_source_dir}")
    if( NOT EXISTS ${test_project_source_dir} )
      message(FATAL_ERROR
        "A test project for linking CXX static library code with exceptions using ${lang} does not exists")
    endif()
